    ...
    <GuestLayout>
        <div class="py-12">
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                <div class="bg-white p-8 shadow dark:bg-gray-800 sm:rounded-lg">
                    ...
                    <div class="space-y-4 text-gray-600 dark:text-gray-300">
                        ...
                        <p>By accessing and using Learning Todo App, you accept and agree to be bound by these Terms of Service.</p>

                        <h2 class="mt-6 text-xl font-semibold">2. User Responsibilities</h2>
                        ...
                        <h2 class="mt-6 text-xl font-semibold">3. Service Modifications</h2>
                        <p>We reserve the right to modify or discontinue the service at any time.</p>

                        <h2 class="mt-6 text-xl font-semibold">4. Limitation of Liability</h2>
